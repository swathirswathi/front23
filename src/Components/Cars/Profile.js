...
function Profile(props) {
  ...
  const [showEditEmail, setShowEditEmail] = useState(false); // Define setShowEditEmail
  const [showEditPhoneNumber, setShowEditPhoneNumber] = useState(false); // Define setShowEditPhoneNumber
